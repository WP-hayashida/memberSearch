...
<body class="bg-light">
    ...
    <div class="container py-4">
        ...
        <!-- ページネーションボタン表示領域 -->
        <div class="container" style="width:94%; margin:auto; margin-top:10px;">
            <div class="row align-items-center">
                <div class="col text-start">
                    <div id="resultInfoTop"></div>
                </div>
                <div class="col text-center">
                    <ul id="pagination" class="pagination pagination-sm mb-0 justify-content-center" style="display: flex;"></ul>
                </div>
                <div class="col"></div> <!-- 右側スペース用 -->
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end align-items-center" style="width:94%; margin:auto; margin-top:10px; padding-bottom:40px">
            <div class="col text-center">
                <ul id="paginationBottom" class="pagination pagination-sm mb-0 justify-content-center" style="display: flex;"></ul>
            </div>
        </div>
