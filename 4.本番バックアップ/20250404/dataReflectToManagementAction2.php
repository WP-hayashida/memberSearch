...
if ($rec = sqlsrv_fetch_array($dyn)) {
	...
	//■ 230522 yamamoto アポストロフィ対応
	//更新
	$UPDATE = "UPDATE TM_MEMBER SET MEUSERID = '" . $rec[0] . "',MESEI = '" . $rec[1] . "',MEMEI = '" . $rec[2] . "',MESEIKANA = '" . $rec[3] . "',MEMEIKANA = '" . $rec[4] . "',MESEX = '" . $rec[5] . "',MEBIRTHDATE = '" . $rec[6] . "',MEZIPCODE = '" . $rec[7] . "',MEPREFECTURECD = '" . $rec[8] . "',MEADDRESS1 = '" . str_replace("'", "''", $rec[9]) . "',MEADDRESS2 = '" . str_replace("'", "''", $rec[10]) . "',MEMOBILENUM = '" . $rec[11] . "',MEPHONENUM = '" . $rec[12] . "',MEMOBILEMAIL = '" . str_replace("'", "''", $rec[13]) . "',MEDATEOFQUIT = '" . $rec[15] . "',MEGROUP = '" . $rec[16] . "',MEEXTERNALGROUP = '" . $rec[17] . "',MEGROUP_FORCANDI = '" . $rec[18] . "',MEAUTHCD_FORCANDI = '" . $rec[19] . "',MEPOSITION = '" . $rec[20] . "',MEGRADE = '" . $rec[21] . "',MEEMPLOYMENT = '" . $rec[22] . "',MEBASE = '" . $rec[23] . "',MEOFFICE_BELONG = '" . $rec[24] . "',MEOFFICE_LOAN = '" . $rec[25] . "',MEUNIT = '" . $rec[26] . "',METEAM = '" . $rec[27] . "',MEJOB = '" . $rec[28] . "',MEAUTHORITY_APP = '" . $rec[29] . "',MEJOB_CC= '" . $mejob_cc . "',MEJOB_RA= '" . $mejob_ra . "',MEJOB_ENTRY= '" . $mejob_entry . "',MEJOB_GENERALAFFAIRS= '" . $mejob_generalaffairs . "',MEJOB_REVIEW= '" . $mejob_review . "' WHERE MEUSERID = '" . $meuserid . "'";
