...
foreach ($_POST['MEUSERID'] as $meuserid) {
	...
	if ($rec = sqlsrv_fetch_array($dyn)) {
		...
		$UPDATE2 = "UPDATE TM_MEMBER SET MEJOB_CC= '" . $mejob_cc . "',MEJOB_RA= '" . $mejob_ra . "',MEJOB_ENTRY= '" . $mejob_entry . "',MEJOB_GENERALAFFAIRS= '" . $mejob_generalaffairs . "',MEJOB_REVIEW= '" . $mejob_review . "' WHERE MEUSERID = '" . $meuserid . "'";
		// print $UPDATE2 . "<br><br>";
